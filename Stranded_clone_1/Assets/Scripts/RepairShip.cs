...
public class RepairShip : BoostEffect
{
    ...
    public override void Apply(GameObject target)
    {
        ...
        target.GetComponent<Spaceship>().shipHealth.Value = Mathf.Min(target.GetComponent<Spaceship>().shipHealth.Value+amount, target.GetComponent<Spaceship>().shipHealthMax);
